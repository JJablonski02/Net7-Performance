...
namespace ModelValidations.Models
{
    public class Person : IValidatableObject
    {
        ...
        [StringLength(40, MinimumLength = 3, ErrorMessage = "{0} too should be " +
            "between {2} and {1} characters long")]
        [RegularExpression("^[A-Za-z .]*$", ErrorMessage = "{0} should contain only aplhabets, space and dot (.)")]
        ...
        [Range(0, 999.99, ErrorMessage = "{0} too should be " +
            "between ${1} and ${2}")]
        ...
        [DateRangeValidator("FromDate", ErrorMessage = "'From Date' " +
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Either of date of birth or age must be supplied", new[] { nameof(PresentAge) });
            }
        }
    }
}
